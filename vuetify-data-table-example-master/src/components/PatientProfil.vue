  ...
  <v-row align="center" class="list px-3 mx-auto">
    ...
    <v-col cols="12" sm="12">
      <v-card class="mx-auto" tile>
        ...
        <v-data-table :headers="headers" :items="patientProfil" disable-pagination :hide-default-footer="true">
    ...
    <v-col cols="12" sm="12">
      <v-card class="mx-auto" tile>
        ...
        <v-data-table :headers="titles" :items="patientHistory" disable-pagination :hide-default-footer="true">
          <template v-slot:[`item.actions`]="{ item }">
    ...
    <v-col cols="12" sm="12">
      <v-card class="mx-auto" tile>
        <v-card-title style="display:flex; justify-content: space-between; align-items: center">
          <p>Report</p>
          <v-btn color="success" small @click="recalculateRisk()">
            Calculate Risk
          </v-btn>
        </v-card-title>
